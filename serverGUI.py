...
class ServerGUI:
    def __init__(self, host, port):
        ...
        self.log_text = scrolledtext.ScrolledText(content_frame, width=60, height=20, font=('Fira Code', 10), bg='#34495e', fg='#ecf0f1')
        self.log_text.grid(row=0, column=0, columnspan=3, pady=10)

        # Entry for command input
        self.command_entry = ttk.Entry(content_frame, width=40, font=('Fira Code', 10))
        self.command_entry.grid(row=1, column=0, pady=10)
        ...
        self.send_command_button.grid(row=1, column=1, pady=10)
